 ...
 * <p>
 * This class delivers some simple functionality that should really be provided by the core Java {@code String} and
...
public abstract class StringUtils {
	...
	private static final String TEST_FOLDER = "test-classes";

	private static final String REAL_FOLDER = "classes";
	...
	/**
	 * Check whether the given CharSequence has actual text. More specifically, returns {@code true} if the string not
	 * {@code null}, its length is greater than 0, and it contains at least one non-whitespace character.
	 * <p>
	 * 
	 * <pre>
	...
	/**
	 * Check whether the given String has actual text. More specifically, returns {@code true} if the string not
	 * {@code null}, its length is greater than 0, and it contains at least one non-whitespace character.
	 * @param str the String to check (may be {@code null})
	 * @return {@code true} if the String is not {@code null}, its length is greater than 0, and it does not contain
	 *         whitespace only
	...
	/**
	 * 将.class文件的绝对路径装换为包路径
	 * @param absolutelypath
	 * @param basepath
	 * @return
	 */
	public static String resolverpackage(String absolutelypath) {
		String className = "";
		if (absolutelypath.indexOf(TEST_FOLDER) > -1) {
			String[] paths = absolutelypath.split(TEST_FOLDER);
			className = paths[1];
		} else {
			String[] paths = absolutelypath.split(REAL_FOLDER);
			className = paths[1];
		}
